...
@NamedQueries({
        ...
        @NamedQuery(name = Meal.GET_BY_ID_USER_ID, query = "SELECT m FROM Meal m WHERE m.id=:id AND m.user.id=:user_id"),
...
public class Meal extends AbstractBaseEntity {
    ...
    public static final String GET_BY_ID_USER_ID = "Meal.get";
